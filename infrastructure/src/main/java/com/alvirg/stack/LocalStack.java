    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        authServiceDb,
                        Map.of(
                                "JWT_SECRET", "sRilhKJvu9aLQbAq3v3VE9X3GyMEKMHOmhhTRygSo14E",
                                "SERVER_PORT", "8088"
                        ));
...
//    }
    ...
    private CfnCluster createMskCluster() {
        // Use this stack's VPC private subnets (MSK requires 2 or 3 valid subnets)
    ...
    private void createApiGatewayService(){
        ...
        ContainerDefinitionOptions containerOptions = ContainerDefinitionOptions.builder()
                ...
                .environment(Map.of(
                        ...
                        "AUTH_SERVICE_URL", "http://auth-service.patient-management.local:8088",
                        "AUTH_SERVICE_URI", "http://auth-service.patient-management.local:8088",
                        "PATIENT_SERVICE_URI", "http://patient-service.patient-management.local:8085"
                ))
                .portMappings(List.of(8333).stream().map(port -> PortMapping.builder()
                                .containerPort(port)
                                .hostPort(port)
                                .protocol(Protocol.TCP)
                                .build())
                ...
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this,  "ApiGatewayLogGroup")
                                .logGroupName("/ecs/" + getStackName() + "/api-gateway")
                                .removalPolicy(RemovalPolicy.DESTROY)
                                .retention(RetentionDays.ONE_DAY)
                                .build())
        ...
        // ALB health check uses / by default; Spring Cloud Gateway returns 404 for /. Use actuator health.
